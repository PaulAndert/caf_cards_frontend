        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(11.99*fem, 132*fem, 10*fem, 24*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                margin: EdgeInsets.fromLTRB(0.24*fem, 0*fem, 0*fem, 59.18*fem),
                                                width: double.infinity,
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      margin: EdgeInsets.fromLTRB(0*fem, 0.45*fem, 122.43*fem, 0*fem),
                                                      width: 14.96*fem,
                                                      height: 13.79*fem,
                                                      child: Image.asset(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 122.67*fem, 0*fem),
                                                      width: 16.46*fem,
                                                      height: 12.54*fem,
                                                      child: Image.asset(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Center(
                                                // E8d (111:1461)
                                                child: Container(
                                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3.48*fem, 0.46*fem),
                                                  child: Text(
                                                    '2',
                                                    textAlign: TextAlign.center,
                                                    style: SafeGoogleFont (
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Center(
                                                // TEu (111:1501)
                                                child: Container(
                                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.85*fem, 0.63*fem),
                                                  child: Text(
                                                    '0',
                                                    textAlign: TextAlign.center,
                                                    style: SafeGoogleFont (
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.99*fem, 0*fem),
